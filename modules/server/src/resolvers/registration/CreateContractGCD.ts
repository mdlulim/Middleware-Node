...
import {annexLines, contractLines} from './GCDContractLines';
...
const createContractGCD = async (
  ...
  return new Promise<string>((resolve, reject) => {
    try {
      ...
      doc.moveDown(10);
      addText('GCD VENDOR CONTRACT', true, false, true, ALIGN.CENTER);
      addText(
      ...
      addText('("GCD")', false, false, false, ALIGN.CENTER);
      ...
      addText('("GCD VENDOR")', false, false, false, ALIGN.CENTER);
      addText(
      ...
      addText('GCD VENDOR DETAILS', true, true);
      addText2(
        'Full Name & Surname',
        profileData.first_name + ' ' + profileData.last_name
      );
